<?php
/**
 * R&F: the paying agent's desk.
 *
 * Commission claims arrive here as bundles — one distributor, their own claim
 * and every dealer voucher they approved. R&F has three jobs and they are the
 ...
 *
 * R&F sees no clients, no stock and no rates. Only who is owed what.
 */
