<?php
/**
 * C&F: the rates every claim is worked out from.
 *
 * C&F pays the partners, so the three commission rates are theirs to set. They
...
/* C&F has no Dealers or Distributors page to send anyone to */
